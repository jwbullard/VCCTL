...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<body>
		<html:form action="/my-files/viewImage.do">
			<bean:define name="viewImageForm" id="sliceName" property="sliceName" />
                        <bean:define name="viewImageForm" id="optype" property="optype" />
			Image Name: <bean:write name="viewImageForm" property="sliceName" />
                        <br></br>
			Plane to view:
			<html:select property="plane">
				<html:option value="yz" />
				<html:option value="xz" />
				<html:option value="xy" />
			</html:select>
                        <br></br>
			Slice to view: <html:text property="sliceNumber" size="6" />
                        <br></br>
			Magnification: <html:text property="magnification" size="4" />X
                        <br></br>
                        Depth Perception:
                        <html:select property="viewdepth">
                        ...
                        <br></br>
			<html:submit>Get image</html:submit>
                        <br></br>
			<div id="slice-image" >
				<img src="/vcctl/image/<%=sliceName%>" alt="Should be an image here!" />
			</div>
