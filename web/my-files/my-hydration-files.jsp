<%-- 
    Document   : my-hydration-files
    Created on : Oct 28, 2011, 2:10:48 PM
    Author     : bullard
--%>
...
<h3>My Hydration Files</h3>
<html:form action="/my-files/editMyHydrationFiles.do">
	<bean:size id="hydrationOperationsNumber" name="myHydrationFilesForm" property="hydrationOperations" />
	<logic:greaterThan name="hydrationOperationsNumber" value="0">
		<fieldset id="hydration-operations">
			...
			<nested:iterate name="myHydrationFilesForm" property="hydrationOperations" indexId="ind">
						...
						<div class="collapsable-content expanded">
												...
												<nested:equal property="viewContent" value="true">
													...
													<nested:equal property="type" value="image">
														...
														<div id="hydration-file-content_<%=ind%>_<%=i%>" class="to-reload file-image"><nested:link action="/my-files/viewImage.do" target="_blank" property="linkParameters"><img src="/vcctl/image/<%=sliceName%>" /></nested:link></div>
                                                                                                        ...
                                                                                                        <nested:equal property="type" value="movie">
														<nested:define id="movieName" property="movieName" />
														<div id="hydration-file-content_<%=ind%>_<%=i%>" class="to-reload file-image"><nested:link action="/my-files/viewHydrationMovie.do" target="_blank" property="linkParameters"><img src="/vcctl/image/<%=movieName%>" /></nested:link></div>
													</nested:equal>
												</nested:equal>
							...
							<nested:notEmpty property="filesList">
								...
								<logic:greaterThan name="filesNumber" value="0">
									Export all files for this operation in one zip file: <nested:link action="/my-files/downloadHydrationFile.do" paramId="operation" paramProperty="name" styleClass="link"><nested:write property="zipArchiveName" /></nested:link>
								</logic:greaterThan>
							</nested:notEmpty>
						</div>
					</fieldset>
