...
***/
int createpgms(void);
int makevrml(int packtype, float x1, float x2, float y1, float y2, float z1, float z2);
int pgms2gifs(void);
...
***************************************************************/
void makevrml(int packtype, float x1, float x2, float y1, float y2, float z1, float z2)
{
	...
	fprintf(vrmlfile,"        point [0.0000,0.0000,1.0000,0.0000,1.0000,1.0000,0.0000,1.0000]}\n");
	fprintf(vrmlfile,"  }\n");
	fprintf(vrmlfile,"}\n");
