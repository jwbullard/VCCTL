...
int runrand3d(int phasein, int phaseout, char filecorr[MAXSTRING],
...
void freeallmem(void)
{
	...
	if (Mask) free_ibox(Mask,Xsyssize+1,Ysyssize+1);
	if (Sum) free_fvector(Sum);
