...
int main(void)
{
	...
	for (i = 1; i <= Ntheta; i++) {
		for (j = 1; j <= Nphi; j++) {
			...
			if (i == 1) theta = 0.001 * Pi;
			if (i == Ntheta) theta = 0.999 * Pi;
	...
	***/
	...
	for (n = 9; n <= Nnn; n++) {
		...
		***/
		...
		/*
		if (n == 31) {
			printf("\n5n = %d n-1 = %d Y.r = %f Y.i = %f",n,n-1,Y[n][n-1].r,Y[n][n-1].i);
			fflush(stdout);
		}
		*/
		...
		*/
		...
		/*
		if (n == 31) {
			printf("\n6n = %d n-1 = %d Y.r = %f Y.i = %f",n,n-1,Y[n][n-1].r,Y[n][n-1].i);
			fflush(stdout);
		}
		*/
		...
		/*
		if (n == 31) {
			printf("\n7n = %d n-1 = %d Y.r = %f Y.i = %f",n,n-1,Y[n][n-1].r,Y[n][n-1].i);
			fflush(stdout);
		}
		*/
		...
		printf("\n\ts = %f xm = %f x = %f realnum = %f",s,xm,x,realnum);
			printf("\n8n = %d n-1 = %d Y.r = %f Y.i = %f",n,n-1,Y[n][n-1].r,Y[n][n-1].i);
			fflush(stdout);
		}
		*/
	}
