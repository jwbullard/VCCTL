...
class CementDialog(MaterialDialogBase):
    ...
    def _add_psd_section(self, container: Gtk.Box) -> None:
        ...
        # Create unified PSD widget for cement
...
class FlyAshDialog(MaterialDialogBase):
    ...
    def _add_psd_section(self, container: Gtk.Box) -> None:
        ...
        # Create unified PSD widget for fly_ash
...
class SlagDialog(MaterialDialogBase):
    ...
    def _add_psd_section(self, container: Gtk.Box) -> None:
        ...
        # Create unified PSD widget for slag
        self.psd_widget = UnifiedPSDWidget('slag')
        self.psd_widget.set_change_callback(self._on_psd_changed)
...
class SilicaFumeDialog(MaterialDialogBase):
    ...
    def _add_psd_section(self, container: Gtk.Box) -> None:
        ...
        # Create unified PSD widget for silica_fume
        self.psd_widget = UnifiedPSDWidget('silica_fume')
        self.psd_widget.set_change_callback(self._on_psd_changed)
...
class LimestoneDialog(MaterialDialogBase):
    ...
    def _add_psd_section(self, container: Gtk.Box) -> None:
        ...
        # Create unified PSD widget for limestone
        self.psd_widget = UnifiedPSDWidget('limestone')
        self.psd_widget.set_change_callback(self._on_psd_changed)
...
def create_material_dialog(parent: 'VCCTLMainWindow', material_type: str, material_data: Optional[Dict[str, Any]] = None):
    """Create a material dialog based on the material type."""
    dialog_classes = {
        'cement': CementDialog,
    ...
    dialog_class = dialog_classes.get(material_type)
